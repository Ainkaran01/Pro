...
const BookNowPortal = (props) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post("http://localhost/quickmatch_api/booking.php", bookingData);
  ...
  const handleCancel = async () => {
    try {
      if (bookingId) {
        await axios.delete(`http://localhost/quickmatch_api/booking.php?id=${bookingId}`);
      }
      setShowPayment(false);
      setBookingDetails(null);
      setBookingId(null);
